    ...
    <section className="relative min-h-[70vh] flex flex-col justify-center items-center text-center px-6 pt-32 pb-16 overflow-hidden bg-[#F9F7F2]">
      ...
      >
        ...
        <div className="pt-8 flex flex-col sm:flex-row gap-8 justify-center">
          ...
          <a href="#acervo" className="border border-black/10 bg-white/50 backdrop-blur-sm hover:bg-white/80 py-6 px-16 rounded-sm transition-all uppercase text-[10px] tracking-[0.3em] font-bold text-[#1A1A1A] hover:-translate-y-1">
            Explorar Acervo
          </a>
        </div>
      </motion.div>
